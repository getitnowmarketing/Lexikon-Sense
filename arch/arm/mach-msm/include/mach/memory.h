...
#elif defined(CONFIG_ARCH_MSM7230) && (defined(CONFIG_MACH_VIVO) || defined(CONFIG_MACH_SAGA) || defined(CONFIG_MACH_FLYER) || defined(CONFIG_MACH_ICON) || defined(CONFIG_MACH_EXPRESS_KT) || defined(CONFIG_MACH_TAG) || defined(CONFIG_MACH_BLISS))
...
#define PHYS_OFFSET		UL(0x04000000)
#elif defined(CONFIG_ARCH_MSM7630) && (defined(CONFIG_MACH_LEXIKONCT) || defined(CONFIG_MACH_VIVOW) || defined(CONFIG_MACH_EXPRESS) || defined(CONFIG_MACH_KINGDOM) || defined(CONFIG_MACH_TAGH) || defined(CONFIG_MACH_EXPRESS_H) || defined(CONFIG_MACH_BLISSC))
