...
#define LEXIKON_KEY_MATRIX_ROW_NUM (7 + 1)
#define LEXIKON_KEY_MATRIX_COL_NUM 8

#define KEYMAP_INDEX(col, row) ((col) * LEXIKON_KEY_MATRIX_ROW_NUM + (row))

static const unsigned short lexikon_keymap_x0[LEXIKON_KEY_MATRIX_COL_NUM *
						LEXIKON_KEY_MATRIX_ROW_NUM] = {
};

static struct resource lexikon_resources_keypad[] = {
	{
...
struct platform_device lexikon_keypad_resource = {
	.name		= PMIC8058_KEYPAD_NAME,
	.id		= -1,
	.num_resources  = ARRAY_SIZE(lexikon_resources_keypad),
	.resource       = lexikon_resources_keypad,
};

static struct pmic8058_keypad_data lexikon_keypad_matrix_info = {
	.info.func = pmic8058_event_matrix_func,
	.input_name = PMIC8058_KEYPAD_NAME,
	.num_rows = LEXIKON_KEY_MATRIX_ROW_NUM,
	.num_cols = LEXIKON_KEY_MATRIX_COL_NUM,
	.rows_gpio_start = 8,
	.cols_gpio_start = 0,
	.keymap_size = ARRAY_SIZE(lexikon_keymap_x0),
	.keymap = (unsigned int *)lexikon_keymap_x0,
	.debounce_ms = {8},
	.scan_delay_ms = 32,
	.row_hold_us = 125,
	.wakeup = 1,
	.p_device = &lexikon_keypad_resource,
...
static void lexikon_sliding_input_gpio(void)
{
	static uint32_t inputs_gpio_table[] = {
		PCOM_GPIO_CFG(LEXIKON_SLIDING_INTZ, 0, GPIO_INPUT,
...
/*
static int lexikon_reset_keys_up[] = {
	KEY_VOLUMEUP,
	0
};
*/
static struct keyreset_platform_data lexikon_reset_keys_pdata = {
	/*.keys_up = lexikon_reset_keys_up,*/
	.keys_down = {
		KEY_POWER,
		KEY_VOLUMEDOWN,
		KEY_VOLUMEUP,
